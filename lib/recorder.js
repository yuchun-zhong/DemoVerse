...
const PLATFORM_VIEWPORTS = {
  bilibili:   { width: 1280, height: 720 },   // 16:9
  youtube:    { width: 1280, height: 720 },   // 16:9
  zhihu:      { width: 1280, height: 720 },   // 16:9
  douyin:     { width: 720, height: 1280 },   // 9:16
  wechat:     { width: 720, height: 1280 },   // 9:16
  xiaohongshu:{ width: 810, height: 1080 },   // 3:4
  custom:     { width: 1280, height: 720 },   // 默认 16:9
};
 ...
 * @param {object} options - 生成选项（含 platform）
 * @param {function} onProgress - 进度回调
 * @returns {Promise<{screenshots: string[], pageData: object}>}
 */
export async function recordPage(url, jobId, options = {}, onProgress = () => {}) {
